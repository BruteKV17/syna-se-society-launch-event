...
const VISION_CHALLENGES = [
  ...
  },
  {
    ...
    svg: `<img src="../assets/images/chatgpt_logo.png" alt="ChatGPT Logo" style="width: 180px; height: 180px; object-fit: contain; filter: drop-shadow(0 0 15px rgba(255,255,255,0.8));" />`
  },
  {
    name: 'Python',
